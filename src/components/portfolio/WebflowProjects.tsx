...
const projects = [
  ...
  {
    title: 'Component Library Website',
    description: 'High-converting marketing site with compelling CTAs, social proof, and mobile-first responsive design.',
    image: webflowSaas,
  ...
  },
  {
    ...
    description: 'Award-winning interactive portfolio showcasing creative projects with smooth 3D animations and transitions.',
    image: webflowPersonal,
    features: ['3D Animations', 'Interactive UI', 'Award Winning'],
